...
public class Day01_2 {//c s
	...
	//3. print() : 출력함수
	//4. ; : 한줄 코드 끝 알림
	// * 시스템클래스 내 out 라는 출력 스트림을 통해 priont 함수를 사용해서 console에 원하는 대로 출력할 수 있다.
	...
	public static void main(String[] args) { //m s
		...
		System.out.println("강호동\t출석\t결석\t출석\t결석");
		System.out.println("유재석\t출석\t결석\t출석\t출석");
		System.out.println("------------------------------------------------------");
