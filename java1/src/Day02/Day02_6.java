...
//  		System.out.println("연령대는 "+연령대+"입니다.");
		...
		System.out.println("정수1을 입력하세요"); int 일수 = scanner.nextInt();
		System.out.println("정수2을 입력하세요"); int 이수 = scanner.nextInt();
		System.out.println("정수3을 입력하세요"); int 삼수 = scanner.nextInt();
